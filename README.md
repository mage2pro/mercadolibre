This extension integrates a Magento 2 based webstore with the **[MercadoLibre](https://en.wikipedia.org/wiki/MercadoLibre)** marketplace (Argentina, Bolivia, Brazil, Chile, Colombia, Costa Rica, Dominican Republic, Ecuador, Guatemala, Honduras, Mexico, Nicaragua, Panama, Paraguay, Peru, Portugal, Salvador, Uruguay, Venezuela).  
...
### 2. Self-installation
```
composer require mage2pro/mercadolibre:*
...
## Support
- [The extension's **forum** branch](https://mage2.pro/c/extensions/mercadolibre).
...
- [Subscribe](https://mage2.pro/t/2540) to the extension's [forum branch](https://mage2.pro/c/extensions/mercadolibre).
